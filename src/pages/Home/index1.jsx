...
export function Home() {
  ...
  return (
    <div className="font-poppins min-h-screen bg-loginBackground bg-cover flex flex-col justify-center items-center py-12 sm:px-6 lg:px-8">
      <div className="relative bg-[#FCFCFC] w-[28.6rem] h-[37.8rem] flex flex-col items-center justify-center shadow-lg rounded-lg">
        ...
        <img
          src={imagemAluno}
          alt="profile"
          className="absolute -top-[3.625rem] w-[8.5rem] h-[8.5rem] rounded-full object-cover border-8 border-[#004D9B] "
        />
        <p className="absolute text-white -top-[-7rem] text-lg ">{nameAluno}</p>
      </div>
    </div>
  );
}